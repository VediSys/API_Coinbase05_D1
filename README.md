...
An Android-based Pydroid template script to obtain mobile cryptocurrency daily quotes via Coinbase and indicate trend, both logically and visually.
...
3) Run 'api_api_cb05_idx.py'
   or 'api_cb_BLPredux.py' in the Pydroid IDE.
